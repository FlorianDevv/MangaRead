...
const DrawerPrimitiveContent = clx(
	...
	"fixed inset-x-0 bottom-0 z-50 mt-1 flex h-auto flex-col rounded-t-[10px] border bg-background top-[0%]",
);
...
>(({ children }) => (
	<DrawerPortal>
		...
		<DrawerPrimitiveContent>
			<div className="mx-auto mb-4 mt-3 h-2 w-[200px] rounded-full bg-muted" />
			{children}
		</DrawerPrimitiveContent>
	</DrawerPortal>
));
