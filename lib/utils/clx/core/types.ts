...
export type ClassNamesAndVariant<V extends Variants> = string | VariantConfig<V>;
...
export type InferVariantProps<V extends Variants | unknown | undefined = undefined> =
  V extends Variants
    ? Partial<{
...
export interface ClassedType<Props extends {} = {}, TComposedVariants extends {} = {}>
